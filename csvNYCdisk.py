...
zip = input("Please enter a New York City zip code: ")
...
for line in lines:              
    if line[8] == zip and "Noise" in line[5]:  #finds noise complaints in zip code user chooses
        noiseList.append(line[5])  # adds zip codes to list to be counted

print("There have been", len(noiseList), "noise complaints in", zip, "from the start of 2015 to July 19, 2017.")
